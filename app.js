            ...
            messages.forEach(function(msg, index) {
                ...
                if (msg.replyTo) {
                    ...
                    if (replyMsg) {
                        ...
                        textContent += `<div style="padding:6px;margin-bottom:8px;border-left:3px solid #ddd;background:#f5f5f5;border-radius:4px;font-size:11px;color:#999;max-width:200px;cursor:pointer;" onclick="event.stopPropagation(); scrollToMessage('${msg.replyTo}'); return false;">
